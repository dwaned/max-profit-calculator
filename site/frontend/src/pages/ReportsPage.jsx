...
function ReportsPage() {
  ...
  const reportCategories = [
    ...
    },
    {
      ...
      color: 'bg-red-500',
      icon: '🎭',
      description: 'End-to-end browser test that drives the real production bundle (vite preview) with a headless Chromium — fills the calculator form, submits, and asserts the result card. This is the only test that verifies the UI can actually be used as expected.',
      reports: [
        {
          id: 'surefire-ui',
          name: 'Test Results',
          description: 'PlaywrightUI test results (in surefire-report.html under com.maxprofit.calculator.PlaywrightUITests)',
          file: 'surefire-report.html#com.maxprofit.calculator.PlaywrightUITests',
        },
        {
          id: 'xref-ui',
          name: 'Test Source Code',
          description: 'PlaywrightUI source code',
