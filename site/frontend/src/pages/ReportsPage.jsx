...
function ReportsPage() {
  ...
  const reportCategories = [
    ...
    },
    {
      ...
      color: 'bg-red-500',
      icon: '🎭',
      description: 'End-to-end browser test that drives the real production bundle (vite preview) with a headless Chromium — fills the calculator form, submits, and asserts the result card. The HTML reporter is the official Playwright one: per-test traces, screenshots, network logs, and an interactive timeline.',
      reports: [
        {
          id: 'playwright-html',
          name: 'Playwright HTML Report',
          description: 'Official Playwright HTML reporter — interactive timeline, traces, screenshots',
        ...
        },
        {
          ...
          description: 'JUnit result for the Java PlaywrightUI test',
          file: 'surefire-report.html#com.maxprofit.calculator.PlaywrightUITests',
        },
        {
          id: 'xref-ui',
          name: 'Test Source Code',
          description: 'PlaywrightUI (Java) source code',
          file: 'xref-test/com/maxprofit/calculator/PlaywrightUITests.html',
        },
      ],
    },
    {
      ...
      reports: [
        {
          id: 'xref-performance',
          name: 'Test Source Code',
          description: 'ApiPerformanceTests source code',
    ...
    },
    {
      ...
      color: 'bg-orange-700',
      icon: '🔥',
      description: 'Algorithm robustness under maximum input — execution time at 100 stocks, memory usage < 512MB, no OutOfMemoryError. Verifies the polynomial DP rewrite does not regress into the original brute-force O(2^n) algorithm.',
      reports: [
        {
          id: 'surefire-stress',
          name: 'Test Results',
          description: 'StressTests results (in surefire-report.html under com.maxprofit.calculator.StressTests)',
          file: 'surefire-report.html#com.maxprofit.calculator.StressTests',
        },
        {
          id: 'xref-stress',
          name: 'Test Source Code',
          description: 'StressTests source code',
